...
nodes=[[] for _ in range(m*n*o*p*q*r*s*t*u*v*w)]
visited=[False]*(m*n*o*p*q*r*s*t*u*v*w)
first_visit=[]
has_zero=False
for a in range(m): 
    for b in range(n):
                                    ...
                                    for j in range(v):
                                        for k in range(w):
                                            ...
                                            try:
                                                ...
                                                if b<n-1:
                                                    if (buf[a][b+1][c][d][e][f][g][h][i][j][k+1]=='0' or buf[a][b+1][c][d][e][f][g][h][i][j][k]=='1') and (current=='0' or current=='1'):
                                                        nodes[node_no].append(node_no+o*p*q*r*s*t*u*v*w)
                                                        nodes[node_no+o*p*q*r*s*t*u*v*w].append(node_no)
                                                if c<o-1:
                                                    if (buf[a][b][c+1][d][e][f][g][h][i][j][k+1]=='0' or buf[a][b][c+1][d][e][f][g][h][i][j][k]=='1') and (current=='0' or current=='1'):
                                                        nodes[node_no].append(node_no+p*q*r*s*t*u*v*w)
                                                        nodes[node_no+p*q*r*s*t*u*v*w].append(node_no)
                                                if d<p-1:
                                                    if (buf[a][b][c][d+1][e][f][g][h][i][j][k+1]=='0' or buf[a][b][c][d+1][e][f][g][h][i][j][k]=='1') and (current=='0' or current=='1'):
